...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AymanStore.DAL.Entities.AbuseProductRatingTBL", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ProductRatingTBLId")
                        .HasColumnType("int");

                    b.Property<string>("SenderUserTBLId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("ID");

                    b.HasIndex("ProductRatingTBLId");

                    b.HasIndex("SenderUserTBLId");

                    b.ToTable("AbuseProductRatingTBLs");
                });
            ...
            modelBuilder.Entity("AymanStore.DAL.Entities.ContactForProductErrorTBL", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsSeenMessageReplyToClient")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("MessageReplyToClient")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ContactForProductErrorTBLs");
                });

            modelBuilder.Entity("AymanStore.DAL.Entities.ContactUsTBL", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AymanStore.DAL.Entities.InvoiceOrderDetailTBL", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsSupplierReceivedMoney")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("OrderDetailTBLId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OrderDetailTBLId");

                    b.ToTable("InvoiceOrderDetailTBLs");
                });

            modelBuilder.Entity("AymanStore.DAL.Entities.InvoiceRateTBL", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AymanStore.DAL.Entities.OrderDetailTBL", b =>
                {
                    ...
                    b.Property<bool>("IsUserWroteReview")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("ShippingCompanyCostTBLId")
                        .HasColumnType("int");

                    b.Property<string>("ShippingCompanyTRKCode")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SupplierPhones")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("ShippingCompanyCostTBLId");
            ...
            modelBuilder.Entity("AymanStore.DAL.Entities.ShippingCompanyCostTBL", b =>
                {
                    ...
                    b.Property<int?>("CountryTBLSendFromId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CountryTBLSendFromId");
            ...
            modelBuilder.Entity("AymanStore.DAL.Entities.AbuseProductRatingTBL", b =>
                {
                    b.HasOne("AymanStore.DAL.Entities.ProductRatingTBL", "ProductRatingTBL")
                        .WithMany()
                        .HasForeignKey("ProductRatingTBLId");

                    b.HasOne("AymanStore.DAL.BaseEntity.AppUser", "SenderUserTBL")
                        .WithMany()
                        .HasForeignKey("SenderUserTBLId");

                    b.Navigation("ProductRatingTBL");

                    b.Navigation("SenderUserTBL");
                });
            ...
            modelBuilder.Entity("AymanStore.DAL.Entities.InvoiceOrderDetailTBL", b =>
                {
                    b.HasOne("AymanStore.DAL.Entities.OrderDetailTBL", "OrderDetailTBL")
                        .WithMany()
                        .HasForeignKey("OrderDetailTBLId");

                    b.Navigation("OrderDetailTBL");
                });
            ...
            modelBuilder.Entity("AymanStore.DAL.Entities.OrderDetailTBL", b =>
                {
                    ...
                    b.HasOne("AymanStore.DAL.Entities.ShippingCompanyCostTBL", "ShippingCompanyCostTBL")
                        .WithMany()
                        .HasForeignKey("ShippingCompanyCostTBLId");
                    ...
                    b.Navigation("ShippingCompanyCostTBL");
            ...
            modelBuilder.Entity("AymanStore.DAL.Entities.ShippingCompanyCostTBL", b =>
                {
                    b.HasOne("AymanStore.DAL.Entities.CountryTBL", "CountryTBLSendFrom")
                        .WithMany()
                        .HasForeignKey("CountryTBLSendFromId");
                    ...
                    b.Navigation("CountryTBLSendFrom");
